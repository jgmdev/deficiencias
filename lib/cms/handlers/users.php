...
class Users
{
     ...
     */
    public function Add(\Cms\Data\User $user)
    {
        $path = $this->GetPath($user->username, $user->group);
    ...
    public static function Delete($username)
    {
        ...
        $path = $this->GetPath($username, $user_exists['group']);
    ...
    public static function Edit($username, \Cms\Data\User $user_data)
    {
        ...
        $user_exist = $this->Exists($username);
        ...
        if($user_exist)
        {
            ...
            {
                $new_path = $this->GetPath($username, $user_data->group);
    ...
    public static function GetDataByEmail($email)
    {
        ...
        if($db->TableExists('users'))
        {
            ...
            {
                $data = $db->FetchArray();
                return $this->GetData($data['username']);
            }
        }
    ...
    public static function Exists($username)
    {
        ...
        if(!is_bool($dir_handle))
        {
            while(($group_directory = readdir($dir_handle)) !== false)
            {
                ...
                {
                    $user_data_path = $this->GetPath($username, $group_directory);
    ...
    public static function EmailTaken($email)
    {
        try
        {
            $user_data = $this->GetDataByEmail($email);
        }
